 ...
 *
 * Centralised content defaults and static data arrays used by the
 * web-development page. Extracted for testability; the page imports
 * from here and optionally overrides via CMS.
 */
...
export const services: ServiceCard[] = [
  ...
  },
  {
    ...
    color: '#06B6D4',
    desc: 'Custom content management systems that give you full control over your content without the bloat of off-the-shelf solutions.',
    features: ['Custom Admin Panel', 'Content Workflows', 'Media Management', 'User Roles & Permissions', 'Headless CMS APIs', 'SEO-Friendly Architecture'],
  },
  {
    emoji: '📱',
