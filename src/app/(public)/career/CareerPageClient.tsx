...
import './career.css'
import type { CareerContent } from '@/lib/career-content'
...
export default function CareerPageClient({ content }: CareerPageClientProps) {
    ...
    <div className="career-page">
      <div className="career-container">
        ...
        <div className="career-hero">
          <picture>
            <source
              ...
              srcSet={content.heroMobileImage}
            />
            <img
        ...
        <div className="career-values-section">
          ...
          <h2 className="career-values-title" dangerouslySetInnerHTML={{ __html: content.valuesHeading }} />
          <p className="career-values-sub" dangerouslySetInnerHTML={{ __html: content.valuesSubtitle }} />
          <div className="career-values-grid">
            {content.values.map((item) => (
              <div key={item.title} className="career-value-card">
                <div
                  className="career-value-icon"
                  style={{ background: item.iconBg || '#FFF1EB', color: item.iconColor || '#FF5B2E' }}
                >
                  <span>{item.icon}</span>
                </div>
        ...
        {/* CTA Banner */}
        <div className="career-cta-banner" id="open-positions">
          <div className="career-cta-banner-inner">
            <h2 className="career-cta-title" dangerouslySetInnerHTML={{ __html: content.ctaHeading }} />
            <p
              className="career-cta-sub"
              dangerouslySetInnerHTML={{ __html: content.ctaDescription.replace('{email}', `<a href="mailto:${content.ctaEmail}">${content.ctaEmail}</a>`) }}
            />
          </div>
        </div>
      </div>
