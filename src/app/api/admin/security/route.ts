...
import { getAttackStats, getHourlyChartData, getDailyChartData } from '@/lib/anti-spam'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const [stats, hourlyChart, dailyChart] = await Promise.all([
      getAttackStats(dateRange),
      getHourlyChartData(),
      getDailyChartData(),
    ])
