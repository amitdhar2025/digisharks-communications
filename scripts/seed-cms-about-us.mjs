/**
 * Seed CMS Page Content — About Us
 *
 * Populates the About Us page with its current hardcoded content
 * so it's ready to edit from the CMS editor.
 *
 * Usage:
 *   npx tsx scripts/seed-cms-about-us.mjs
 */
...
// ── About Us DEFAULT_CONTENT (mirrors src/app/(public)/about-us/page.tsx) ──
const ABOUT_US_CONTENT = {
  heroEyebrow: '✦ About Digisharks',
  heroHeading: 'Build lasting <span class="orange-text">brand value</span> with digital PR & growth.',
  ...
  aboutCompanyHeading: 'Digisharks Communications <span class="orange-text">Since 2017</span>',
  ...
  valuesHeading: 'What <span class="orange-text">Drives Us</span> Forward',
  ...
  timelineHeading: '10+ Years of <span class="orange-text">Building & Growing</span>',
  ...
  boothHeading: 'Booth Management <span class="orange-text">Services</span>',
  ...
  achievementsHeading: 'Our Achievements in <span class="orange-text">Numbers</span>',
  ...
  faqHeading: 'About <span class="orange-text">Working With Us</span>',
...
async function main() {
  console.log('')
  console.log('╔══════════════════════════════════════════════╗')
  console.log('║     Seed CMS Page Content — About Us        ║')
  console.log('╚══════════════════════════════════════════════╝')
  console.log('')
  ...
  console.log(`✅ About Us page content seeded successfully!`)
  console.log(`   Page: ${result.pageName} (${result.pageSlug})`)
  console.log(`   ID: ${result._id}`)
  console.log('')
  console.log('You can now edit this content at:')
  console.log('   http://localhost:3000/content/admin/pages/about-us/edit')
  console.log('')
